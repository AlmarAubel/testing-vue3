import type { Args, Renderer, ComposedStoryPlayFn, StoryId, Parameters, StoryFn, StoryAnnotations } from '@storybook/types';
type LooseAnnotatedStoryFn<TRenderer extends Renderer = Renderer, TArgs = Args> = (args?: TArgs) => (TRenderer & {
    T: TArgs;
})['storyResult'];
export type PreparedStoryFn<TRenderer extends Renderer = Renderer, TArgs = Args> = LooseAnnotatedStoryFn<TRenderer, TArgs> & {
